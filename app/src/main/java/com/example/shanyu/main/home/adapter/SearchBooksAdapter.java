...
public class SearchBooksAdapter extends BaseAdapter {
    ...
    public SearchBooksAdapter(Context mContext, List<BookMode> names, BookOnClick onClick) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.adapter_book_search_item, parent, false);
